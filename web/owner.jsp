...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="container"><br />
                <div class="home" style="width: 1000px;height:  400px;background-image: url('images/owner.jpg');margin-left: 200px;border-radius: 20px;margin-top: 10px;"><br >
                    <h1 style="color: black;margin-left: 50px;">Welcome to Data Owner</h1>
                </div><br />
