...
<html>
    ...
    <body>
        ...
        <div id="main">
            <div id="header">
                <center><h1 style="color: black">Encrypted Data Storage Vs Data Against illegal Access</h1></center><br>
            ...
            <div id="container"><br />
                <div class="home" style="width: 1000px;height:  400px;background-image: url('images/Admini.jpg');margin-left: 200px;border-radius: 20px;margin-top: 0px;"><br /><br /><br /><br />
                    <h1 style="color: white;margin-left: 10px; color: white">Welcome to Admin</h1>
                </div>
